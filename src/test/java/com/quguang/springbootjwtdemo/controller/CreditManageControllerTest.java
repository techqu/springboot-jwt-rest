...
@WebAppConfiguration
public class CreditManageControllerTest extends Tester {
    ...
    @Test
    public void creditStatusQuery() {
    }

    @Test
    public void creditStatusList() throws Exception{
        /**
        ...
        MvcResult mvcResult= mockMvc.perform(MockMvcRequestBuilders.get("/credit/statusList")
//                .param("name","lvgang")
