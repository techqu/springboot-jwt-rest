...
/**
 * Created by 瞿广 on 2019/3/24 0024.
 */
...
//设定端口，申明启动类！！重要
@SpringBootTest(webEnvironment = SpringBootTest.WebEnvironment.DEFINED_PORT, classes = SpringbootJwtDemoApplication.class)
...
//        Swagger2MarkupConverter.from(new URL("http://localhost:8080/v2/api-docs"))
        Swagger2MarkupConverter.from(Paths.get("./docs/swagger.json"))
                               .withConfig(config)
                               .build()
